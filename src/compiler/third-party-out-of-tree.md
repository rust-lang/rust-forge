...
- It is fine to have additional reviewers with merge permissions on the crate who do not otherwise
  have r+ for Rust as a whole, if those reviewers are actively involved in the working group or
  crate maintenance.
