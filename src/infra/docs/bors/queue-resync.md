...
<div class="warning">
**WARNING**: This is a **destructive** operation. If someone syncs, they need to
...
**You can only do this if you have bors `r+` permissions on the rust-lang/rust
repo.**
...
EDIT(jieyouxu): edited to prevent bors from picking up command in a future sync
```
